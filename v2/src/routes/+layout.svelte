  ...
  <header class="sticky top-0 z-50 bg-white">
    <div class="w-full px-4 sm:px-6 py-2.5 flex items-center justify-between gap-4">
      <div class="flex flex-col gap-0.5" style={headingWidth ? `width:${headingWidth}px` : ''}>
        <a href="/" bind:this={headingEl} class="no-underline inline-flex flex-col w-min">
          ...
          <span class="text-[0.6rem] text-[#9ca3af] font-medium truncate">Open-Source TGPC Pharmacist Data</span>
        </a>
